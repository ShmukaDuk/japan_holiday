    ...
    items: [
      {
        ...
        description: "A snack crawl through Osaka's famous 'Kitchen of Japan'. Fun Fact: The market has been around since the Edo period, over 190 years!",
      ...
      },
      {
        ...
        description: "Best for walking, browsing, and random finds. Fun Fact: Shinsaibashi-suji is one of the oldest and most representative shopping centers in Japan.",
